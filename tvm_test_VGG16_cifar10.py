...
if local_demo:
    ...
    dylib_path = "../tvm_output_lib/VGG16_cifar10.so"
    dylib_path_tuned = "../tvm_output_lib/VGG16_cifar10_tuned.so"
else:
    target = tvm.target.arm_cpu("rasp5b")
    dylib_path = "../tvm_output_lib/VGG16_cifar10_aarch.tar"
    dylib_path_tuned = "../tvm_output_lib/VGG16_cifar10_aarch_tuned.tar"
print(target)
input_name = "input"
...
tuning_option = {
    ...
    "tuning_records": "VGG16_cifar10_tunning.json",
}
